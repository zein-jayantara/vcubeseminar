...
function check_password(){
	...
	var len = tmp.length;
	if(len == 0){
		$("#password_error").html(M.util.get_string('js_error_password', 'vcubeseminar'));
...
function stop_confernce(){
	ret = confirm(M.util.get_string('js_stop_confernce', 'vcubeseminar'));
	return ret;
}
//]]>