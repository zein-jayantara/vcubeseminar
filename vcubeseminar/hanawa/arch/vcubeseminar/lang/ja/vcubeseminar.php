...
$string['vcubeseminar:addinstance'] ='講師権限';

$string['alias'] ='API設定名';
$string['aliasdesc'] ='API設定に付与する名称です。';
...
$string["domainlist"] = "登録済みドメイン";
$string["domainlist_edit"] = "変更する";
$string["domainlist_cancel"] = "キャンセル";
$string["domainlist_delete"] = "削除する";
$string["domainlist_add"] = "登録する";
$string["domainlist_update"] = "変更する";
$string["domainlist_delete_confirm"] = "本当に削除しますか";